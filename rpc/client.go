...
// the given `ctx`.
func (c *Client) Call(ctx context.Context, method string, arg any, res any, timeout time.Duration) error {
...
func (c *Client) CallCompressed(ctx context.Context, method string,
	arg any, res any, ctype CompressionType, timeout time.Duration,
) error {
...
func (c *Client) Notify(ctx context.Context, method string, arg any, timeout time.Duration) (err error) {
	if ctx == nil {
...
type GenericClient interface {
	Call(ctx context.Context, method string, arg any, res any, timeout time.Duration) error
	CallCompressed(ctx context.Context, method string,
		arg any, res any, cType CompressionType, timeout time.Duration) error
	Notify(ctx context.Context, method string, arg any, timeout time.Duration) error
}
